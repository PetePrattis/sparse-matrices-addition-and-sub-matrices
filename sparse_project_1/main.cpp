...
// ένα αντικείμενο Node ο οποίος αντιπροσωπεύει την αραιή μήτρα
struct Node {
    int value; // η τιμή
    int rowp; // η θέση στις σειρές
    int colp; // η θέση στις στήλες
    struct Node *next; // επόμενο
};

// μια μέθοδος η οποία όταν καλείται δημιουργεί ένα νέο αντικείμενο Node
void create_new_Node(struct Node** start, int non_zero_element, int row, int column){
    struct Node *temp, *r;
    temp = *start;
    if (temp == NULL){
        // δημιουργω ένα νέο Node δυναμικά
...
//αυτή η μέθοδος εμφανίζει τα αντικείμενα της διασυνδεδεμένης λίστας
void PrintList(struct Node* start){
    struct Node *temp; //δημιουργώ ένα νέο αντικείμενο τύπου Node
    temp = start;//το αρχικοποιώ με το αντικείμενο που πέρασα μέσα στην μέθοδο

    printf("row_position: ");
    while(temp != NULL){//για όλο τον αριθμό των αντικείμενων εμφανίζω τις σειρές

        printf("%d ", temp->rowp);
        temp = temp->next;// πάω στο επόμενο
    }
    printf("\n");

    temp = start;//ξανά αρχικοποιώ το αντικείμενο μου με το αντικείμενο που πέρασα στην μέθοδο
    printf("column_postion: ");
    while(temp != NULL){//για όλο τον αριθμό των αντικείμενων εμφανίζω τις στήλες
        printf("%d ", temp->colp);
        temp = temp->next;// πάω στο επόμενο
    }
    printf("\n");
    ...
    temp = start;//ξανά αρχικοποιώ το αντικείμενο μου με το αντικείμενο που πέρασα στην μέθοδο
    printf("Value: ");
    while(temp != NULL){//για όλο τον αριθμό των αντικείμενων εμφανίζω τις τιμές
        printf("%d ", temp->value);
        temp = temp->next;// πάω στο επόμενο
    }
    printf("\n");
